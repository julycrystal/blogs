    ...
    return (
      <Html lang="en" className="scroll-smooth">
        <Head>
          ...
          <meta
            name="description"
            content="Welcome to my personal blog where I share my julycrystals. I am a Data Engineer passionate about Data Science, building pipelines and Automation."
          />
